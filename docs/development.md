...
> Note: Nestjs Services Template uses [TypeORM](https://github.com/typeorm/typeorm) with Data Mapper pattern.
...
After completing the steps above, you can use [this docker-compose file](../docker-compose_mysql.yml) for nestjs-services-template with MySQL (instead of PostgreSQL).
